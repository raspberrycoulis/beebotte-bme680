...
temp_resource = Resource(bbt, 'BME6802', 'temperature')
pressure_resource = Resource(bbt, 'BME6802', 'pressure')
humidity_resource = Resource(bbt, 'BME6802', 'humidity')
airqual_resource = Resource(bbt, 'BME6802', 'airqual')
